...
export default function NavBar() {
    ...
    return (
        ...
        <nav className='flex flex-row bg-slate-900 px-80 py-1 gap-20'>


            <div className='flex justify-start gap-4'>

                <Link className='flex min-h-fit min-w-fit' href='https://github.com/Clavvv' rel="noopener noreferrer" target='_blank'> 
            ...
            <NavItem link='/' text='Votes' />

            <NavItem link='/' text='Data' />

            <NavItem link='/' text='Members' />
